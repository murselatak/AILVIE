...
const renderSettings=()=>{const s=settingsTab;const all=s==="all";return(<div style={{display:"flex",flexDirection:"column",gap:10}}>
  ...
  {(all||s==="subs")&&<div style={CS}><div style={{fontWeight:700,marginBottom:8}}>💎 {t.subscription}</div>
    ...
    {[
{n:t.free,p:"$0",d:t.freePlan,c:sc,active:true,features:lang==="tr"?["Sınırsız ilaç takibi","Sınırsız not","Günlük 3 AI mesajı","60+ dilde çeviri (10/gün)","Topluluk erişimi","Sağlık skoru","İlaç alarmları","Hasta karnesi","Acil rehber"]:["Unlimited medications","Unlimited notes","3 daily AI messages","60+ language translation (10/day)","Community access","Health score","Med reminders","Patient card","Emergency contacts"]},
{n:"PRO "+(lang==="tr"?"Aylık":"Monthly"),p:"$4.99/"+t.monthly,d:t.premPlan,c:ac,active:false,features:lang==="tr"?["Sınırsız AI sohbet","Sınırsız AI çeviri (60+ dil)","Detaylı ilaç analizi","Risk faktörü AI analizi","Premium kadın sesli asistan","Öncelikli yanıt hızı","Reklamsız"]:["Unlimited AI chat","Unlimited AI translation (60+ langs)","Detailed drug analysis","AI risk factor analysis","Premium female voice","Priority response","Ad-free"]},

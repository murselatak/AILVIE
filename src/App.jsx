...
const renderChat=()=>(<div style={{display:"flex",flexDirection:"column",gap:8,flex:1,minHeight:0,height:"100%"}}>
...
return (
  <div style={{width:"100%",maxWidth:480,margin:"0 auto",height:"100dvh",display:"flex",flexDirection:"column",overflow:"hidden",background:bg,fontSize:fs,color:tc,fontFamily:"'SF Pro Display',-apple-system,'Segoe UI',system-ui,sans-serif",direction:rtl?"rtl":"ltr",position:"relative"}}>
        ...
        {/* Content */}
        <div style={{flex:1,minHeight:0,overflowY:page==="chat"?"hidden":"auto",overflowX:"hidden",padding:page==="chat"?"10px 12px 8px":"10px 12px 8px",display:page==="chat"?"flex":"block",flexDirection:"column",cursor:"default",WebkitOverflowScrolling:"touch"}} onClick={(e)=>{if(e.target===e.currentTarget){setEditNote(null);setNOpen(false);setShowAddMed(false);setShowAddAppt(false);setShowAddC(false);setShowWordLangPicker(false);setSelDate(null);}}}>{pages[page]?.()}</div>

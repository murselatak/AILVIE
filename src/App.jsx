...
const NOTE_BGS=[{k:"none",g:null},{k:"dots",g:svgPat("<circle cx='16' cy='16' r='2.6' fill='rgba(255,255,255,0.20)'/>",32,32)+",linear-gradient(135deg,#3a2f52,#523a5e)"},{k:"waves",g:svgPat("<path d='M0 18 Q10 8 20 18 T40 18' fill='none' stroke='rgba(255,255,255,0.22)' stroke-width='2.2'/>",40,26)+",linear-gradient(135deg,#1e3a4f,#2f5a6e)"},{k:"leaves",g:svgPat("<path d='M18 4 C10 12 10 24 18 32 C26 24 26 12 18 4 Z' fill='none' stroke='rgba(255,255,255,0.22)' stroke-width='1.4'/><path d='M18 6 L18 30' stroke='rgba(255,255,255,0.16)' stroke-width='1'/>",36,36)+",linear-gradient(135deg,#1e3a2e,#2f4f3e)"},{k:"pulse",g:svgPat("<path d='M0 20 H24 L30 6 L38 34 L46 20 H120' fill='none' stroke='rgba(255,255,255,0.24)' stroke-width='2.2'/>",120,40)+",linear-gradient(135deg,#4f2330,#6e3a4a)"},{k:"triangles",g:svgPat("<path d='M18 6 L30 28 L6 28 Z' fill='none' stroke='rgba(255,255,255,0.20)' stroke-width='1.6'/>",36,36)+",linear-gradient(135deg,#3a2e4f,#5a3a6e)"},{k:"grid",g:svgPat("<path d='M28 0 H0 V28' fill='none' stroke='rgba(255,255,255,0.16)' stroke-width='1'/>",28,28)+",linear-gradient(135deg,#2a2f38,#3a4150)"},{k:"confetti",g:svgPat("<circle cx='10' cy='12' r='2.4' fill='rgba(255,255,255,0.22)'/><rect x='34' y='8' width='5' height='5' fill='rgba(255,255,255,0.18)'/><circle cx='46' cy='42' r='2.4' fill='rgba(255,255,255,0.18)'/><rect x='12' y='42' width='5' height='5' fill='rgba(255,255,255,0.16)'/>",58,58)+",linear-gradient(135deg,#4f2e2e,#6e4a3a)"},{k:"rings",g:svgPat("<circle cx='20' cy='20' r='12' fill='none' stroke='rgba(255,255,255,0.18)' stroke-width='1.6'/><circle cx='20' cy='20' r='5' fill='none' stroke='rgba(255,255,255,0.14)' stroke-width='1.2'/>",40,40)+",linear-gradient(135deg,#123a3a,#1f5a58)"},{k:"stars",g:svgPat("<path d='M27 14 l2 6 6 0 -5 4 2 6 -5 -4 -5 4 2 -6 -5 -4 6 0 z' fill='rgba(255,255,255,0.22)'/><circle cx='10' cy='40' r='1.6' fill='rgba(255,255,255,0.18)'/><circle cx='44' cy='10' r='1.6' fill='rgba(255,255,255,0.16)'/>",54,54)+",linear-gradient(135deg,#2a2e52,#3a3a6e)"}];

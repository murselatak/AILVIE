        ...
        <div style={{background:`linear-gradient(135deg,${ac},${a2})`,padding:"2px 10px",paddingTop:"max(env(safe-area-inset-top),2px)",display:"flex",justifyContent:"space-between",alignItems:"center",flexShrink:0}}>
          ...
          <div style={{display:"flex",gap:5,alignItems:"center",flexShrink:0}}>
            <button onClick={goBack} aria-label="Geri" style={{background:"none",border:"none",padding:0,cursor:"pointer",display:"flex",alignItems:"center",filter:"drop-shadow(0 1px 2px rgba(0,0,0,0.4))"}}>
              <svg width="33" height="33" viewBox="0 0 30 30" fill="none" stroke="#e8a817" strokeWidth="2.4" strokeLinecap="round" strokeLinejoin="round"><g transform="rotate(-40 15 16)"><path d="M15.1 6.5 A 10 10 0 0 1 15.1 25.5"/><path d="M22.1 4.5 L15.1 6.5 L18.1 13.5"/></g></svg>
            </button>
